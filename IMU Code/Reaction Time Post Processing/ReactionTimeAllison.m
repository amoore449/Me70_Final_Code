...
if t == 1
    if d == 1
        Data = readtable('Trial01A_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(22,[2:5]));
    end
    if d == 2
        Data = readtable('Trial01B_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(23,[2:5]));
    end
    if d == 3
        Data = readtable('Trial01C_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(24,[2:5]));
    end 
end
if t == 2
    if d == 1
         Data = readtable('Trial02A_Allison_AccelerationX.xlsx');
         trial_time = table2array(trial_times(25,[2:5]));
    end
    if d == 2
        Data = readtable('Trial02B_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(26,[2:5]))
    end
    if d == 3
        Data = readtable('Trial02C_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(27,[2:5]));
    end 
end
if t == 3
    if d == 1
         Data = readtable('Trial03A_Allison_AccelerationX.xlsx');
         trial_time = table2array(trial_times(28,[2:5]));
    end
    if d == 2
        Data = readtable('Trial03B_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(29,[2:5]));
    end
    if d == 3
        Data = readtable('Trial03C_Allison_AccelerationX.xlsx');
        trial_time = table2array(trial_times(30,[2:5]));
    end 
end
...
if d == 1
    sgtitle("No Distraction(Allison)")
end
if d == 2
    sgtitle("Texting Distraction(Allison)")
end
if d == 3
    sgtitle("Gaming Distraction(Allison)")
end
...
figure(4)
hold on
title("Reaction Time for Different Distraction Conditions (Allison)")
